...
export default function LayerButton(props: Props): JSX.Element {
	...
	if (props.link) return (
		<div className={`flex items-stretch justify-start min-w-[15rem] min-h-[4.3rem] relative + ${props.classes}`}>
			<Link href={props.link} className={'flex-1 text-2xl min-w-full min-h-full flex items-center' +
				' justify-center bg-primary-100 rounded-xl text-primary-500 font-bold'}>
				{props.text}
			</Link>
